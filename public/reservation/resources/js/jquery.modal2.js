...
(function($)
{
	...
	$.modal = function(options)
	{
		...
		{
			$('<ul class="action-tabs right"><li><a href="#" title="Close window"><img src="/ECMDeveloper/reservation/resources/images/icons/fugue/cross-circle.png" width="16" height="16"></a></li></ul>')
				.prependTo(win)
