...
//		$ds->debug_sql = true;
	...
	function countbookingByDriver0($arg_input, $drivers, $driverBookings)
	{
		...
		$headings2 = array("รายงานสรุปปริมาณการขับรถ", '');
		$headings3 = array("จากเดือน " . $this->month[$arg_input['start_mounth_1']] . " ปี " . $srYear . " เดือน " . $this->month[$arg_input['sะนย_mounth_1']] . " ปี " . $spYear, '');
		...
		for ($cYear = $srYear; $cYear <= $spYear; $cYear++)
		{
			...
			$count_col_xls = 65;
			$worksheet->write(chr($count_col_xls) . $count_row_xls, 'ปี ' . $cYear, $format3);
			$blank = 0;
...
//echo $driver['driver_id'];
	...
	function countbookingByDriver1($arg_input, $drivers, $driverBookings)
	{
		...
		$headings1 = array("สำนักงานคณะกรรมการกำกับและส่งเสริมการประกอบธุรกิจประกันภัย", '');
		$headings2 = array("รายงานสรุปปริมาณการขับรถ", '');
		$headings3 = array("จากปี $srYear ถึงปี $spYear", '');
