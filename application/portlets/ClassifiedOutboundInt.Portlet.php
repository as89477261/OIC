...
class ClassifiedOutboundPortletInt {
	...
	public function getUI() {
		...
		$DIVName = "ClassifiedOutboundIntUIDIV";
		$programID = "COI_0";
		$gridName = 'gridClassifiedOutboundIntItem';
	    ...
	    $regBookID = 0;
	    $storeName = "COIStore_{$regBookID}";
	    $RIStore = $dfStore->getCOIStore($regBookID,$storeName);
		...
		tb_{$programID}.add({
            ...
            handler: function() {
            	...
            	Ext.getCmp('filterSendType').setValue('SendSecInt');            	
			}
        },{
        ...
        /*,{
            ...
            handler: function(e) {
            	...
            	popupExcelReport('SSI',pageData_{$programID}.activePage);
			}
        }/*,{
