<?php
/**
 * Portlet : หนังสือส่งภายนอกทะเบียนกลาง
...
class GlobalSendExternalPortlet {
	...
	public function getUI() {
		...
		$DIVName = "GlobalSendExternalUIDIV";
		$programID = "GSE_0";
		$gridName = 'gridGlobalSendExternalItem';
		$filterMenuName = 'GSEFilteredMenu';
	    ...
	    $regBookID = 0;
	    $storeName = "GSEStore_{$regBookID}";
	    $RIStore = $dfStore->getSGStore($regBookID,$storeName);
		...
		tb_{$programID}.add({
            ...
            handler: function() {
            	...
            	Ext.getCmp('filterSendType').setValue('SendExtGlobal');
			}
        },{
        ...
        /*,{
            ...
            handler: function(e) {
            	...
            	popupExcelReport('SG',pageData_{$programID}.activePage);
            	//Ext.MessageBox.confirm('Confirm', 'Delete Account [ '+{$gridName}.getSelectionModel().getSelected().get('name')+']?', deleteSelectedAccount);
			}
        },{
            text:'{$lang['df']['fetch']}',
