...
class SendInternalPortlet {
	...
	public function getUI() {
		...
		$DIVName = "SendInternalUIDIV";
		$programID = "SI_0";
		$gridName = 'gridSendInternalItem';
		$filterMenuName = 'SIFilteredMenu';
	    ...
	    $regBookID = 0;
	    $storeName = "SIStore_{$regBookID}";
	    $RIStore = $dfStore->getSIStore($regBookID,$storeName);
		...
		tb_{$programID}.add({
            ...
            handler: function() {
            	...
            	Ext.getCmp('filterSendType').setValue('SendInt');
			}
        },{
            ...
            handler: function(e) {
            	...
            	popupExcelReport('SI',pageData_{$programID}.activePage);                                                                                       
			}
        },{
            text:'{$lang['df']['fetch']}',
            iconCls: 'refreshIcon',
