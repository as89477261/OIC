...
class ClassifiedOutboundPortletExt {
	...
	public function getUI() {
		...
		$DIVName = "ClassifiedOutboundExtUIDIV";
		$programID = "COE_0";
		$gridName = 'gridClassifiedOutboundExtItem';
	    ...
	    $regBookID = 0;
	    $storeName = "COEStore_{$regBookID}";
	    $RIStore = $dfStore->getCOEStore($regBookID,$storeName);
		...
		tb_{$programID}.add({
            ...
            handler: function() {
            	...
            	Ext.getCmp('filterSendType').setValue('SendSecExt');            	
			}
        },{
        ...
        /*,{
            ...
            handler: function(e) {
            	...
            	popupExcelReport('SSE',pageData_{$programID}.activePage);
			}
        }/*,{
            ...
            handler: function(e) {
            	...
            	Ext.getCmp('reportType').setValue('outboundClassified');
			}
        }*/,{
            text:'{$lang['df']['fetch']}',
            iconCls: 'refreshIcon',
