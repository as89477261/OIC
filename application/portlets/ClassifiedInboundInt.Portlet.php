...
class ClassifiedInboundPortletInt {
	...
	public function getUI() {
		...
		$DIVName = "ClassifiedInboundIntUIDIV";
		$programID = "CII_0";
		$gridName = 'gridClassifiedInboundIntItem';
		$filterMenuName = 'CIIFilteredMenu';
		...
		$auditSubMenu = "{
	            ...
	            disabled: false,
	            handler: function(e) {
	            	Ext.MessageBox.confirm('Confirm', 'บันทึก [ '+{$gridName}.getSelectionModel().getSelected().get('title')+'] เป็นรายการติดตาม?', addToTrackRS);
				}
	        },{
	    ...
	    $regBookID = 0;
	    $storeName = "CIIStore_{$regBookID}";
	    $CIIStore = $dfStore->getCIIStore($regBookID,$storeName);
		...
		$callModule = 'ReceivedClassifiedInt';
		...
		tb_{$programID}.add({
            ...
            handler: function() {
            	...
            	Ext.getCmp('filterRecvType').setValue('RecvSecInt');
			}
        },{
        ...
        /*,{
            ...
            handler: function(e) {
            	...
            	popupExcelReport('RSI',pageData_{$programID}.activePage);
			}
        },/*{
