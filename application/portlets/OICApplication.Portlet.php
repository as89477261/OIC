...
class OICApplicationPortlet {
	...
	public function getUI() {
        ...
        <table width=\"100%\">
			...
			<tr>
				...
				<td style=\"cursor: pointer;\" onclick=\"popupOldApp2('tab_outgoingMainFolder3','http://backoffice.oic.or.th/pmis2/ECMLogin.php?loginName={$account->f_login_name}');\">
	...
	public function assetSystem() {
		...
		$account = new AccountEntity();
		$account->Load("f_acc_id = '{$loginName}'");
		$url="http://backoffice.oic.or.th/wpmis/ECMLogin.php";
