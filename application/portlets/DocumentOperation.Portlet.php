            ...
            items: [
                {
                    ...
                    items: [
                    {
                        ...
                        items:[{
							...
							autoCreate : {tag: 'input', type: 'text', maxlength: '1000'}
                        }),new Ext.form.ComboBox({
                            store: autocompleteReceiverTextStore,
                            fieldLabel: 'เรียน',
                            displayField:'name',
            ...
            items: [{
                    ...
                    items: [{
                        ...
                        items:[{
                            ...
                            xtype:'checkbox',
                            fieldLabel: 'จองเลข',
							hideLabel: true,//   คุณลัยแจ้งให้ปิดการใช้งานเมื่อ 29-02-2012
                            allowBlank: true,
                            checked: false,
                            disabled: true,
							hidden: true,
                                    ...
                                    Ext.Ajax.request({
                                        ...
                                        success: function(o){
                                              ...
                                              var reserveMsg = '';
                                                ...
                                                if(r.reserve == 1) {
                                                	reserveMsg = 'เลขที่จอง <span style=\"color:blue;font-weight:bold;\">'+r.bookNoR+'</span><br/>';
    											}
                                                //alert(regNo);
                                                docNo = r.docno;
                                                regNo = r.regno;  
                                                ...
                                                Ext.MessageBox.show({
                                                    title: 'การส่งภายใน',
                                                    msg: 'ส่งเรียบร้อยแล้ว<br/>หนังสือเลขที่ : <b>'+docNo+'</b><br/>' +reserveMsg+ 'ส่งวันที่ :  '+sendDate+',เวลา : '+sendTime,
                                                    buttons: {yes:'แนบเอกสาร' ,no:'ตกลง'},
                                                    fn: function(id,str) {
                                                    	if(id=='yes') {
                                ...
                                if(r.redirectLogin == 1) {
                                    ...
                                    Ext.Ajax.request({
                                        ...
                                        success: function(o){
    										...
    										if(r.reserve == 1) {
                                                reserveMsg = '<br/>เลขที่จอง <span style=\"color:blue;font-weight:bold;\">'+r.bookNoR+'</span><br />';
    										}
                                            docNo = r.docno;
                                            regNo = r.regno;
                                            sendDate = r[0].recvDate;
            ...
            items: [
                {
                    ...
                    items: [
                    {
                        ...
                        items:[{
                            ...
                            width: 280,
                            height: 65,
							autoCreate : {tag: 'textarea', maxlength: '2000'}
                        },{
                            xtype:'textarea',
                               fieldLabel: 'รายละเอียด',
                            name: 'recvExtDesc',
    ...
    private function sentInternalListWindowJS() {
        ...
        var sendInternalListWindow = new Ext.Window({
            ...
            buttons: [{
                ...
                id: 'btnDeleteContactList',
                text: 'Delete List',
                handler: function() {
                    Ext.MessageBox.confirm('{$lang['common']['confirm']}', 'ต้องการลบบัญชีรายชื่อ ?', deleteContactList);	
                }
            },{
        ...
        sendInternalListWindow.on('show',function(t) {
            Ext.getCmp('contactListAutoComplete').clearValue();
            Ext.getCmp('SendToSelector').focus('', 10);
        },this);
        
        function deleteContactList(btn, text) {
            if( btn == 'yes') {
                Ext.MessageBox.show({
                    msg: 'กำลังลบบัญชีรายชื่อ รอสักครู่...',
                    progressText: 'ลบข้อมูล...',
                    width:300,
                    wait:true,
                    waitConfig: {interval:200},
                    icon:'ext-mb-download'
                ...
                Ext.Ajax.request({
                    url: '/{$config ['appName']}/contact-list/delete',
                    method: 'POST',
                    success: function(o){
                        var r = Ext.decode(o.responseText);
                        if(r.success == 1){
                        Ext.MessageBox.show({
                            title: 'การลบบัญชีรายชื่อ',
                            msg: 'ลบเรียบร้อยแล้ว',
                            buttons: Ext.MessageBox.OK,
                            icon: Ext.MessageBox.INFO
                        }); 
                    ...
                    params: {
	                 	contactList: Ext.getCmp('contactListAutoComplete').value                 	   
                    }
                });
            }
        }
    ...
    private function sentExternalListWindowJS() {
        ...
        var sendExternalListWindow = new Ext.Window({
            ...
            buttons: [{
                ...
                text: 'Delete List',
                handler: function() {
                    Ext.MessageBox.confirm('{$lang['common']['confirm']}', 'ต้องการลบบัญชีรายชื่อ ?', deleteExternalContactList);	
                }
            },{
        ...
        function deleteExternalContactList(btn, text) {
            if( btn == 'yes') {
                Ext.MessageBox.show({
                    msg: 'กำลังลบบัญชีรายชื่อ รอสักครู่...',
                    progressText: 'ลบข้อมูล...',
                ...
                Ext.Ajax.request({
                    ...
                    success: function(o){
                        ...
                        Ext.MessageBox.show({
                         ...
                         Ext.getCmp('contactListExternalAutoComplete').clearValue();
                         tempSendExternalStore.removeAll();
                        } else {
	                         Ext.MessageBox.show({
	                        title: 'การลบบัญชีรายชื่อ',
                    ...
                    params: {
	                 	contactList: Ext.getCmp('contactListExternalAutoComplete').value                 	   
                    }
                });
            }
        }
...
//										,instanceIDA: {$docID}
        ...
        Ext.getCmp('extraOrgNameA').on('select',function(c,record,i) {
            dataRecord = c.store.getAt(i);
            Ext.getCmp('extraOrgIDA').setValue(dataRecord.data.id); 
        },this);
