...
class ClassifiedInboundPortlet {
	...
	public function getUI() {
		...
		$DIVName = "ClassifiedInboundUIDIV";
		$programID = "CI_0";
		$gridName = 'gridClassifiedInboundItem';
		$filterMenuName = 'CIFilteredMenu';
	    ...
	    $regBookID = 0;
	    $storeName = "CIStore_{$regBookID}";
	    $RIStore = $dfStore->getRSStore($regBookID,$storeName);
		...
		tb_{$programID}.add({
            ...
            handler: function() {
            	...
            	Ext.getCmp('filterRecvType').setValue('RecvSec');
			}
        },{
        ...
        /*,{
            ...
            handler: function(e) {
            	...
            	popupExcelReport('RS',pageData_{$programID}.activePage);
			}
        },{
