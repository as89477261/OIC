...
class SendCircPortlet {
	...
	public function getUI() {
		...
		$DIVName = "SendCircUIDIV";
		$programID = "SC_0";
		$gridName = 'gridSendCircItem';
		$filterMenuName = 'SCFilteredMenu';
	    ...
	    $regBookID = 0;
	    $storeName = "SCStore_{$regBookID}";
	    $RIStore = $dfStore->getSCStore($regBookID,$storeName);
		...
		tb_{$programID}.add({
            ...
            handler: function() {
            	...
            	Ext.getCmp('filterSendType').setValue('SendCirc');
			}
        },{
        ...
        /*,{
            ...
            handler: function(e) {
            	...
            	popupExcelReport('SC',pageData_{$programID}.activePage);
            	//Ext.MessageBox.confirm('Confirm', 'Delete Account [ '+{$gridName}.getSelectionModel().getSelected().get('name')+']?', deleteSelectedAccount);
			}
        },{
            text:'{$lang['df']['fetch']}',
