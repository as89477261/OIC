...
class ExtraCommandPortlet {
	function getUI() {
		...
		$html = "<table width=\"100%\">
			...
			<tr>
				<td>
					<span style=\"cursor: pointer; display:none;\" id=\"changePasswordSpan\"><img src=\"/{$config ['appName']}/images/th/ChangePassword.png\"/></span><br/>
					<span style=\"display:none;\">{$lang['common']['lastChangePwd'] } [{$sessionMgr->getLastChangePassword()}]</span>
				</td>
			</tr>
			<tr>
				<td>
