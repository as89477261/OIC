...
class ReceivedExternalPortlet {
	...
	public function getUI() {
		...
		$callModule = 'ReceivedExternal';
		if($sessionMgr->isGoverner()) {
			$dblClickFunction = "Cookies.set('docRefID',{$gridName}.getSelectionModel().getSelected().get('recvID'));
			//viewDocumentCrossModule('viewDOC_'+{$gridName}.getSelectionModel().getSelected().get('recvID'),{$gridName}.getSelectionModel().getSelected().get('title'),'RE',{$gridName}.getSelectionModel().getSelected().get('docID'),{$gridName}.getSelectionModel().getSelected().get('recvID'));
		...
		tb_{$programID}.add({
            ...
            disabled: true,
            handler: function(e) {
            	Ext.getCmp('commandTransType').setValue('RE');
        ...
        /*,{
            ...
            handler: function(e) {
            	...
            	popupExcelReport('RE',pageData_{$programID}.activePage);
			}
        }/*,{
