...
$config ['libVersion'] ['zf'] = '1.8.2';
$config ['libVersion'] ['adodb'] = '5.0.8a';
...
$config ['module'] ['KBase'] =true;
$config ['module'] ['Workflow'] = true;
...
$config ['clusterMember'] = Array('192.168.8.122','192.168.8.123');
...
$config ['db'] ['control'] ['database'] = 'BKOFF1';
...
$config ['xmpp'] ['domain'] = 'oic.or.th';
$config ['xmpp'] ['host'] = '192.168.8.119';
$config ['xmpp'] ['broadcastServiceName'] = 'broadcast.oic.or.th';
$config ['xmpp'] ['username'] = 'admin';
$config ['xmpp'] ['password'] = 'slcadmin';
...
//
$config ['sendTimeout'] = 3000000;

//
$config ['AJAXTimeout'] = 3000000;  
...
$config['autoApproveReceiveExternal']=false;

$config['enablePrintMasterDoc']=true;
...
$config['doc2000SearchURL'] = "http://localhost/doc2000/search.php";
##################################################################
# Section 10 : Misc
##################################################################
...
$config['manual']['DF'] = "http://backoffice.oic.or.th/downloads/fieldguide.pdf";
