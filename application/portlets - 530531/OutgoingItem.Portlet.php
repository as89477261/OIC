...
class OutgoingItemPortlet {
	...
	public function getUI() {
		...
		$DIVName = "OutgoingItemUIDIV";
		$programID = "OGI_0";
		$gridName = 'gridOutgoingItem';
		$filterMenuName = 'OGIFilteredMenu';
	    ...
	    $regBookID = 0;
	    $storeName = "OGIStore_{$regBookID}";
	    $RIStore = $dfStore->getOutgoingStore($regBookID,$storeName);
		...
		tb_{$programID}.add({
            ...
            handler: function() {
            	...
            	Ext.getCmp('filterSendType').setValue('OutGoing');            	
			}
        },{
        ...
        /*,{
        	...
        	id: 'btnSaveExcelCommand_{$programID}',
