<?php
/**
 * Portlet : หนังสือส่งภายในทะเบียนกลาง
...
class GlobalSendInternalPortlet {
    ...
    public function getUI() {
        ...
        $DIVName = "GlobalSendInternalUIDIV";
        $programID = "GSI_0";
        $gridName = 'gridGlobalSendInternalItem';
        $filterMenuName = 'GSIFilteredMenu';
        ...
        $regBookID = 0;
        $storeName = "GSIStore_{$regBookID}";
        $RIStore = $dfStore->getSGIStore($regBookID,$storeName);
        ...
        tb_{$programID}.add({
            ...
            handler: function() {
                ...
                Ext.getCmp('filterSendType').setValue('SendGlobalInt');
            }
        },{
        ...
        /*,{
            ...
            handler: function(e) {
                ...
                popupExcelReport('SGI',pageData_{$programID}.activePage);
                //Ext.MessageBox.confirm('Confirm', 'Delete Account [ '+{$gridName}.getSelectionModel().getSelected().get('name')+']?', deleteSelectedAccount);
            }
        },{
            text:'{$lang['df']['fetch']}',
