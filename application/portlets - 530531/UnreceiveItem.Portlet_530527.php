...
class UnreceiveItemPortlet {
	...
	public function getUI() {
	    ...
	    var cmUnreceivedItem = new Ext.grid.ColumnModel([{
    	...
    	var tbUnreceiveItem = Ext.getCmp('unreceiveItemToolbar');
	 	...
	 	tbUnreceiveItem.add({
            ...
            handler: function() {
				...
				Ext.getCmp('filterRecvType').setValue('Unreceive');
			}
		},{
	    ...
	    gridUnreceivedItem.on({
			'rowclick' : function() {
                ...
                //alert(gridUnreceivedItem.getSelectionModel().getSelected().get('sendID'));
