...
class CompletedItemPortlet {
	...
	public function getUI() {
		...
		$DIVName = "CompletedItemUIDIV";
		$programID = "PCM_0";
		$gridName = 'gridCompletedItem';
		$filterMenuName = 'PCMFilteredMenu';
	    ...
	    $regBookID = 0;
	    $storeName = "PCMStore_{$regBookID}";
	    $RIStore = $dfStore->getPersonalCompletedStore($regBookID,$storeName);
		
		$callModule = 'CompletedItem';		
		...
		tb_{$programID}.add({
            ...
            handler: function() {
            	...
            	Ext.getCmp('filterSendType').setValue('Completed');
			}
		},{
